...
| Anomaly # | Timestamp (UTC) | Feature(s) | Depth | Trade Volume Context | Heuristic Alignment | Suspicion |
|-----------|----------------|------------|-------|-------------------|------------------|-----------|
...
- **Findings:** Persistent buy-side dominance (96% of time on buy-side domination) with occasional dips coinciding with orderbook anomalies #2 and #3.  
